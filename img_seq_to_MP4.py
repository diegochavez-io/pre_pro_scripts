...
source_folder = '/Users/ekeko/Downloads/images_out/segment_4_stable_warpfusion_0.23.0'
# Output file name
output_file = os.path.join(os.path.dirname(source_folder), '_random_clip_9_78d6d3.mp4')
